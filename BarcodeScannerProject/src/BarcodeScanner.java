 ...
 *
 * 
 * Build a program to read the barcode and display the secret message that is instilled into them.
 * We will use DataMatrix to store the BarcodeImage interface and this will then provide
 * methods for accesing data from the class.  
 */
import java.util.*;
...
class DataMatrix implements BarcodelIO
{
